...
class ImageOAK_D(Camera.Frame):
    ...
    def __init__(
        ...
        self.data = {"disp": frameDisp}  # "rgb": frameRgb
        ...
        self.file_format = {"rgb": "png", "disp": "npy"}
...
class CameraOAK_D(Camera):
    def __init__(
        ...
        # Callback functions
        self.frame_callback: Callable[[ImageOAK_D], None]
    ...
    def set_frame_callback(self, callback: Callable[[ImageOAK_D], None]) -> None:
        """
        ...
        with self.device as device:
            ...
            while True:
                ...
                if latestPacket["rgb"] is not None:
                    frameRgb = latestPacket["rgb"].getCvFrame()[:, 240:-240]
    ...
    def post_process_thumbnail(self, frame, frame_id: str):
        ...
        if frame_id == "disp":
            ...
            frame = np.clip(frame, 0, max_disp)
            frame = (frame / max_disp * 255).astype(np.uint8)
