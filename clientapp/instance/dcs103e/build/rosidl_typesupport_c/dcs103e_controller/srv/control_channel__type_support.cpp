...
static const _ControlChannel_Request_type_support_symbol_names_t _ControlChannel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dcs103e_controller, srv, ControlChannel_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dcs103e_controller, srv, ControlChannel_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dcs103e_controller, srv, ControlChannel_Request)() {
  return &::dcs103e_controller::srv::rosidl_typesupport_c::ControlChannel_Request_message_type_support_handle;
}
...
static const _ControlChannel_Response_type_support_symbol_names_t _ControlChannel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dcs103e_controller, srv, ControlChannel_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dcs103e_controller, srv, ControlChannel_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dcs103e_controller, srv, ControlChannel_Response)() {
  return &::dcs103e_controller::srv::rosidl_typesupport_c::ControlChannel_Response_message_type_support_handle;
}
...
static const _ControlChannel_type_support_symbol_names_t _ControlChannel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dcs103e_controller, srv, ControlChannel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dcs103e_controller, srv, ControlChannel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dcs103e_controller, srv, ControlChannel)() {
  return &::dcs103e_controller::srv::rosidl_typesupport_c::ControlChannel_service_type_support_handle;
}
