...
{
  new (message_memory) piper_msgs::srv::MoveArm_Request(_init);
}

void MoveArm_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<piper_msgs::srv::MoveArm_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveArm_Request_message_member_array[1] = {
  {
    ...
    offsetof(piper_msgs::srv::MoveArm_Request, move_idx),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveArm_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(piper_msgs::srv::MoveArm_Request),
...
{
  return &::piper_msgs::srv::rosidl_typesupport_introspection_cpp::MoveArm_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm_Request)() {
  return &::piper_msgs::srv::rosidl_typesupport_introspection_cpp::MoveArm_Request_message_type_support_handle;
}
...
void MoveArm_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) piper_msgs::srv::MoveArm_Response(_init);
}

void MoveArm_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<piper_msgs::srv::MoveArm_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveArm_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(piper_msgs::srv::MoveArm_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveArm_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(piper_msgs::srv::MoveArm_Response),
...
{
  return &::piper_msgs::srv::rosidl_typesupport_introspection_cpp::MoveArm_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm_Response)() {
  return &::piper_msgs::srv::rosidl_typesupport_introspection_cpp::MoveArm_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MoveArm_service_members = {
  ...
  // see get_service_type_support_handle<piper_msgs::srv::MoveArm>()
...
get_service_type_support_handle<piper_msgs::srv::MoveArm>()
{
  ...
  auto service_type_support =
    &::piper_msgs::srv::rosidl_typesupport_introspection_cpp::MoveArm_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<piper_msgs::srv::MoveArm>();
}
