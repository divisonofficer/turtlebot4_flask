...
static const _MoveArm_Request_type_support_symbol_names_t _MoveArm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveArm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm_Request)),
  }
};
...
{
  return &::piper_msgs::srv::rosidl_typesupport_cpp::MoveArm_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, piper_msgs, srv, MoveArm_Request)() {
  return get_message_type_support_handle<piper_msgs::srv::MoveArm_Request>();
}
...
static const _MoveArm_Response_type_support_symbol_names_t _MoveArm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveArm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm_Response)),
  }
};
...
{
  return &::piper_msgs::srv::rosidl_typesupport_cpp::MoveArm_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, piper_msgs, srv, MoveArm_Response)() {
  return get_message_type_support_handle<piper_msgs::srv::MoveArm_Response>();
}
...
static const _MoveArm_type_support_symbol_names_t _MoveArm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveArm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, piper_msgs, srv, MoveArm)),
  }
};
...
{
  return &::piper_msgs::srv::rosidl_typesupport_cpp::MoveArm_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, piper_msgs, srv, MoveArm)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<piper_msgs::srv::MoveArm>();
}
